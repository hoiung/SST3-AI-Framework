...
LIMITS = {
    ...
    "SST3/standards": 25000,   # raised 2026-04-08 18000->20000 for AP #9-#14 + Subagent Discipline; raised 2026-04-19 20000->22000 for AP #19 + Structural Code Queries subsection (#419). Partially offset by compressing the inline 12-moment prose (now an AP #19 pointer in the "Structural Code Queries" section of STANDARDS.md) (saved ~130 words, #420 Phase 2 item 13). Raised 2026-04-21 22000->25000 for round-5 N32 Double-Guardrail Principle + TA-7 data-layer gate (STANDARDS.md 6th pre-query gate) + TB-5 Rule 8 orchestrator-prop (#427).
