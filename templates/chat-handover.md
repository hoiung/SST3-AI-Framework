...
- Author + run research/explore/audit/verify/review swarms via the Workflow tool (DEFAULT; read-tier subtasks for reads, main agent on the heavyweight model); Agent/Task = trivial-single-angle fallback
